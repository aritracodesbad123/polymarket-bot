...
def test_defaults():
    ...
    assert s.micro_min_abs_imbalance == 0.55
...
def test_micro_phase1_env(monkeypatch, tmp_path):
    ...
    assert overridden.micro_min_abs_imbalance == 0.70
